  ...
  <div className="flex justify-between flex-col px-10 py-10 rounded-[20px] max-w-[370px] md:mr-10 sm:mr-5 mr-0 my-5 feedback-card">
    ...
    <div className="flex flex-row">
      ...
      <div className="flex flex-col ml-4">
        <h4 className="font-poppins font-semibold text-[20px] leading-[32px] text-white text-left">{name}</h4>
        <p className="font-poppins font-normal text-[16px] leading-[24px] text-dimWhite text-left">{title}</p>
      </div>
    </div>
